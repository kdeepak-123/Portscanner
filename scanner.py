...
def prepare_args():
	...
	"""
	parser = ArgumentParser(description="Python Based Fast port scanner",usage="%(prog)s 192.168.0.1",epilog="Example: %(prog)s -s 20 -e 30000 -t 500 -V 192.168.0.1")
